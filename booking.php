...
<body>
	...
	echo "		<option value=\"\">Singapore to Kuala Lumpur <\/option>";
	echo "		<option value=\"\">Kuala Lumpur to Penang </option>";
	echo "		<option value=\"\">Johor to Kuala Lumpur </option>";
	echo "		<option value=\"\">Penang to Cameron Highlands </option>";
	echo "		<option value=\"\">Penang to Singapore </option>";
	echo "		<option value=\"\">Penang to Kuala Lumpur </option>";
	echo "		<option value=\"\">Kuala Lumpur to Johor </option>";
	echo "		<option value=\"\">Singapore to Malacca </option>";
	echo "		<option value=\"\">Ipoh to Kuala Lumpur </option>";
	echo "		<option value=\"\">Penang to Malacca </option>";
	echo "		<option value=\"\">Singapore to Hatyai</option>";
	echo "		<option value=\"\">Malacca to Singapore </option>";
	echo "		<option value=\"\">Kuala Lumpur to Ipoh </option>";
	echo "		<option value=\"\">Malacca to Penang </option>";
	echo "		<option value=\"\">Singapore to Penang </option>";
	echo "		<option value=\"\">KLIA to Kuala Lumpur </option>";
	echo "		<option value=\"\">Ipoh to Singapore </option>";
	echo "		<option value=\"\">Singapore to Genting Highlands</option>";
	echo "		<option value=\"\">Singapore to Ipoh </option>";
	echo "		<option value=\"\">Kuala Lumpur to KLIA </option>";
	echo "		<option value=\"\">Kuala Lumpur to Singapore </option>";
	echo "		<option value=\"\">Singapore to Genting Highlands</option>";
    echo "</select>";
	echo "</div>"; 
	echo "</div>";
    ...
    echo "  <option value=\"\">Single-decker</option>";
	echo "  <option value=\"\">Double-decker</option>";
	echo "  <option value=\"\">Deluxe</option>";
	echo " <option value=\"\">Coach</option>";
	echo "</select>";
	echo "</div>";  
	echo "</div>";
	...
	echo "<div class=\"ui icon input\">";
	echo "<input value=\"25.63\" type=\"text\" id=\"amount\" readonly>";
	echo "</div></div>";
	echo "<div style=\"text-align:center\">";
	...
	echo '<table>';
	echo '<tr>';
	echo '<th>Ticket Owner</th>';
	echo '<th>Destination</th>';
	echo '<th>Date of Travel</th>';
	echo '<th>Type of Bus</th>';
	...
	echo '';
	echo '<tr>';
	echo '<th><?php echo $_POST["fullname"]?></th>';
	echo '<th><?php echo $_POST["destination"]?></th>';
	echo '<th><?php echo $_POST["traveldate"]?></th>';
	echo '<th><?php echo $_POST["typeofbus"]?></th>';
	echo '<th><?php echo $_POST["seats"]?></th>';
	echo '<th><?php echo $_POST["amount"]?></th>';
	echo '<th><?php echo $_POST["codebox"]?></th>';
	echo '';
	echo '</tr>';
